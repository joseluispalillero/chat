...
use MilSonUno\Chat\Live\Broadcast;
...
class Chat
{
     ...
     *
     * @var \MilSonUno\Chat\Conversations\ConversationRepository
     */
     ...
     *
     * @var \MilSonUno\Chat\Messages\MessageRepository
     */
    protected $message;
     ...
     *
     * @var \MilSonUno\Chat\Live\Broadcast
     */
    protected $broadcast;
     ...
     *
     * @param \MilSonUno\Chat\Conversations\ConversationRepository $conversation
     * @param \MilSonUno\Chat\Messages\MessageRepository           $message
     */
     ...
     *
     * @return \MilSonUno\Chat\Messages\Message
     */
     ...
     *
     *@param \Chat\Conversations\Conversation $conversations
     *@return object|bool
     */
     ...
     *
     * @param   int $id
     * @return  \MilSonUno\Chat\Chat|bool
     * */
     ...
     * @param string $message
     *
     * @return \MilSonUno\Chat\Messages\Message|bool
     */
    ...
    public function getReceiverInfo($conversationId)
    {
        ...
        $userModel = $this->config('Chat.user.model');
        $user = new $userModel();
